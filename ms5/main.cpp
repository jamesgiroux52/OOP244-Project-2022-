...
// eg. './name_of_exe 50' will start the program with 50 spots *** between 1-100 ***
// if no argument is passed or it is not between 1 -100 then the deafault 10 spots is used
